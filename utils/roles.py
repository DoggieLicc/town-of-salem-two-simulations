...
Arsonist = Role(name='Arsonist', limit=6, color=0xdb7601)
SerialKiller = Role(name='Serial Killer', limit=6, color=0x0437f2)
Shroud = Role(name='Shroud', limit=6, color=0x6699ff)
Werewolf = Role(name='Werewolf', limit=6, color=0x9d7038)

# NEUTRAL EVIL (unique colors)
Doomsayer = Role(name='Doomsayer', limit=6, color=0x00cc99)
Executioner = Role(name='Executioner', limit=6, color=0x949797)
Jester = Role(name='Jester', limit=6, color=0xf5a6d4)
Pirate = Role(name='Pirate', limit=1, color=0xecc23e)
